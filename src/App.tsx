...
const trackablePages = ["route-list", "deliveries", "rooster", "plano-vm", "gallery-album", "gallery-site-images", "settings-profile"]
    ...
    <>
      ...
      >
        ...
        <Suspense fallback={null}>
          <div
            className={`flex flex-col flex-1 min-h-0 ${(currentPage === "deliveries" || currentPage === "route-list" || currentPage === "gallery-site-images" || currentPage === "plano-vm") ? "overflow-hidden" : "overflow-y-auto"} ${isTransitioning ? "page-fade-out" : "page-fade-in"}`}
